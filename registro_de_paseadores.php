			...
			<div class="col-md-6 offset-md-3">
				...
				<form action="inicio.html">
					<div class="form-group">
						...
						<input type="nombre" class="form-control" id="exampleFormControlInput3" </div> <div
							class="form-group">
						<label for="exampleFormControlInput1">Edad</label>
						<input type="edad" class="form-control" id="exampleFormControlInput1" </div> <div
							class="form-group">
						<label for="exampleInputPassword1">Telefono/celular</label>
						<input type="telefono/celular" class="form-control" id="exampleInputPassword1" </div> <form>
						<div class="form-row">
