...
<form>
  <div class="form-group">
    ...
    <input type="file" class="form-control-file" id="Foto de perfil1">
  </div>
</form>
<div class="form-group">
    <label for="exampleFormControlSelect1">Cantidad de perros por paseo</label>
...
<div class="form-group">
    <label for="exampleFormControlSelect1">Preferencia de tamaño de perro a pasear</label>
    <select class="Seleccione" id="exampleFormControlSelect1">
  ...
  <div class="form-group">
    <label for="exampleFormControlSelect1">Zona(s) de paseo</label> 
    <textarea class="form-control" id="Descripcion1" rows="3"></textarea>
  </div>

  <div class="form-group">
    <label for="exampleInputPassword1">Monto a cobrar por paseo </label>
